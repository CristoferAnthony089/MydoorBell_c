...
@section('contenido')
    ...
    <br><br>
    <br><br>
    <form action="{{ route('category.destroy', $datos->id_cat) }}" class="w-75 m-auto" method="POST">
        @csrf
        @method('DELETE')
        <h3 class="text-center">¿Desea eliminar la categoria {{ @$datos->nombre_cat ?? 'Sin categoria' }} ?</h3>
